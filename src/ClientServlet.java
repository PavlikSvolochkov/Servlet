...
//----------------------------------------------------------------------------------------------------------------------
      ...
      out.println("<form name='addClient' action='ClientServlet'>");
      out.println("<input type='text' name='name' value='Tosh'/>");
      out.println("<br/>");
      out.println("<input type='text' name='surname' value='Kengur'/>");
      out.println("<br/>");
      out.println("<input type='text' name='dateofbirth' value='2029-01-01'/>");
      out.println("<br/>");
...
//----------------------------------------------------------------------------------------------------------------------      
    ...
    System.out.println("CLIENT INFO: " + name.toUpperCase() + surname.toUpperCase() + dateOfBirth.toUpperCase());
  }
